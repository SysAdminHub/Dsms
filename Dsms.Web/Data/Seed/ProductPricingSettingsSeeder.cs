...
public static class ProductPricingSettingsSeeder
{
    public static async Task SeedAsync(ApplicationDbContext db)
    {
        ...
        db.ProductPricingSettings.Add(new ProductPricingSettings
        {
            ...
            IncludedTenantCount = ProductPricingDefaults.IncludedTenantCount,
            AdditionalTenantMonthlyPrice = ProductPricingDefaults.AdditionalTenantMonthlyPrice,
            AdditionalTenantYearlyPrice = ProductPricingDefaults.AdditionalTenantYearlyPrice,
