...
public interface IComplianceAuditLogService
{
    ...
    Task LogProcessingActivityUpdatedAsync(int id, string name, int tenantId, object? oldValues = null, object? newValues = null);
    ...
    Task LogDpiaUpdatedAsync(int id, string title, int tenantId, object? oldValues = null, object? newValues = null);
    ...
    Task LogTomUpdatedAsync(int id, string title, int tenantId, object? oldValues = null, object? newValues = null);
    ...
    Task LogProcessorUpdatedAsync(int id, string name, int tenantId, object? oldValues = null, object? newValues = null);
    ...
    Task LogMeasureUpdatedAsync(int id, string title, int tenantId, object? oldValues = null, object? newValues = null);
    ...
    Task LogAuditUpdatedAsync(int id, string title, int tenantId, object? oldValues = null, object? newValues = null);
    ...
    Task LogAuditTemplateUpdatedAsync(int id, string title, int? tenantId, object? oldValues = null, object? newValues = null);
