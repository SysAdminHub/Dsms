...
|--------|----------|-------|
| superuser@datenschutz-cloud.eu | Demo123! | Superuser (Plattform) |
| admin@datenschutz-cloud.eu | Demo123! | Admin (Demo-Lizenz, Mandant Hauptsitz) |
| auditor@datenschutz-cloud.eu | Demo123! | Auditor |
| user@datenschutz-cloud.eu | Demo123! | User (Mandant Hauptsitz) |
| auditor.sued@datenschutz-cloud.eu | Demo123! | Auditor (Mandant Niederlassung Süd) |
| user.sued@datenschutz-cloud.eu | Demo123! | User (Mandant Niederlassung Süd) |
...
4. Als Superuser anmelden (`superuser@datenschutz-cloud.eu` / `Demo123!`).
